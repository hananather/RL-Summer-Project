...
\title{RL Summer Project (Draft)}
\subtitle{MAT 6997}
\author{Hanan Ather \& Aaron Smith}
\date{Due Date: August 30, 2023}
...
\input{lectures/section0}
\input{lectures/section1}
\input{lectures/section2}
\input{lectures/section3}
\input{lectures/Section4}
\input{lectures/section5}
\input{lectures/section6}
\input{lectures/bib}
\end{document}
